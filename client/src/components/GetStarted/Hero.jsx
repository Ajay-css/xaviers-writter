...
import gradientImg from "../../assets/gradient_arc.svg"
const Hero = () => {
  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-6 md:px-16 lg:px-24 text-center overflow-hidden bg-gradient-to-br from-blue-50 via-white to-cyan-50">
        ...
        {/* Headline */}
        <h1 className="text-xxl md:text-6xl font-semibold leading-tight max-w-4xl text-gray-900">
          Transform Your{" "}
        ...
        {/* Subtext */}
        <p className="mt-6 max-w-xl text-gray-600 text-lg font-medium">
          Xaviers Writer empowers creators and brands to craft clear,
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-6">
          <Link to="/login">
            <button className="px-8 py-3 rounded-full bg-gradient-to-r from-blue-600 to-cyan-500 hover:scale-105 transition text-white shadow-xl shadow-blue-200 font-semibold">
              Start Writing
            </button>
          </Link>

          <button className="px-8 py-3 rounded-full border border-blue-200 hover:border-blue-400 transition text-gray-700 hover:text-blue-600 font-medium">
            Explore Features
          </button>
        </div>
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-10 text-gray-600 text-sm">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-gray-900">50K+</h2>
            Articles
          </div>
          <div>
            <h2 className="text-2xl font-semibold text-gray-900">99%</h2>
            Satisfaction
          </div>
          <div>
            <h2 className="text-2xl font-semibold text-gray-900">24/7</h2>
            Support
          </div>
        </div>
      </section>
